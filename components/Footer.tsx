        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8">
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-4">
            ...
            <div>
              ...
              <h4 className="text-xs font-medium text-on-surface mb-4 uppercase tracking-wide">Download The App</h4>
              <div className="flex gap-2">
                ...
                <Link href="#" className="w-7 h-7 rounded-full border border-on-surface flex items-center justify-center hover:bg-on-surface hover:text-surface-container-lowest transition-colors">
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.523 15.341c-.5 0-.91-.41-.91-.91s.41-.91.91-.91.91.41.91.91-.41.91-.91.91zm-11.046 0c-.5 0-.91-.41-.91-.91s.41-.91.91-.91.91.41.91.91-.41.91-.91.91zm11.4-6.271l1.99-3.44c.11-.19.04-.44-.15-.55-.19-.11-.44-.04-.55.15l-2.02 3.5c-1.52-.69-3.23-1.08-5.14-1.08s-3.62.39-5.14 1.08l-2.02-3.5c-.11-.19-.36-.26-.55-.15-.19.11-.26.36-.15.55l1.99 3.44C2.77 10.81.5 14.18.5 18h23c0-3.82-2.27-7.19-5.63-8.93z"/>
                  </svg>
                </Link>
              </div>
            </div>
      ...
      <div className="border-t border-outline-variant">
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 text-xs text-outline">
            <span>Powered by Mamta International</span>
